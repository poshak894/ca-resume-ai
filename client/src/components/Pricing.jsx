...
export default function Pricing({ startPay, setPage }) {
  ...
  return (
    <div style={{ paddingTop: 80, paddingLeft: 24, paddingRight: 24, maxWidth: 1200, margin: '0 auto', minHeight: '100vh', textAlign:'center' }}>
      ...
      <p style={{ color: 'var(--text-muted)', marginBottom: 40 }}>One-time payment for lifetime articleship success</p>
      ...
      <div className="flex gap-6 justify-center flex-wrap">
        ...
        <div className="pricing-card text-left" style={{flex:1, minWidth:280, maxWidth:340, borderColor:'var(--gold)', position:'relative'}}>
          ...
          <button className="pricing-bubbles-btn pricing-bubbles-gold" onClick={() => startPay('tools')}>
            <span className="text">
            🎙️ Unlock Tools — ₹50
            </span>
          </button>
        ...
        <div className="pricing-card text-left" style={{flex:1, minWidth:280, maxWidth:340, borderColor:'var(--t)', position:'relative'}}>
          ...
          <button className="pricing-bubbles-btn pricing-bubbles-deep" onClick={() => startPay('pro')}>
            <span className="text">
            💳 Upgrade to Pro — ₹199
            </span>
          </button>
